...
import { useGetCompanyOrdersQuery } from "../../redux/api/orderAPI";
...
const CompanyOrders = () => {
    ...
    const { data: orders, refetch } = useGetCompanyOrdersQuery(queryParams);
                    ...
                    <>
                        <UncontrolledDropdown>
                            ...
                            <DropdownMenu end container="body">
                                <DropdownItem className="w-100" onClick={() => navigate(`/company/orders/detail/${row._id}`)}>
